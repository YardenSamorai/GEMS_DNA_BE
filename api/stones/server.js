...
// 🔹 API להחזרת כל האבנים מטבלת stones (לא קשור ל-selector)
...
// 🔹 API להחזרת אבנים מתוך soap_stones (ל-Stone selector החדש)
app.get("/api/soap-stones", async (req, res) => {
  try {
    // ⚠️ בלי LIMIT – מושכים את כל המלאי, הפאגינציה נעשית ב-Frontend
